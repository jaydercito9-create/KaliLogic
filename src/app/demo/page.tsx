    ...
    <main className="auth-page demo-page">
      <section className="demo-aside">
        ...
        <div className="demo-aside__copy">
          ...
          <h2>Crea tu negocio real en segundos. Tendrás 24 horas para usarlo completo.</h2>
          <p>Se genera tu empresa + productos, stock y movimientos según tu rubro (ropa, cosmética, etc).</p>
          <ul>
